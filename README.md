...
The workflow uses the [HBV]() conceptual hydrological model and [Caravan](https://doi.org/10.1038/s41597-023-01975-w) catchment data, driven by ERA5 reanalysis and CMIP6 climate projections.
...
3. Generates historical and future meteorological forcing from ERA5 and CMIP6
...
The result is a comparison of discharge behaviour under historical conditions versus four future climate scenarios (SSP1-2.6, SSP2-4.5, SSP3-7.0, SSP5-8.5), based on one or more CMIP6 models and ensemble members.
